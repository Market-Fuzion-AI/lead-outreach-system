...
OUTREACH MESSAGE STYLE (applies to first_message, follow_up_1, follow_up_2, close_the_loop):
- Write like a real person sending a short message, not a marketing agency. Short, natural sentences. Plain English. Low pressure.
- NEVER use em dashes ("—") in these messages. Use periods and commas instead. Keep each message concise.
- Do not over-explain. No fake enthusiasm, no hype, no "10x", no hard selling, no technical jargon.
- BANNED phrases (never use any of these): "Hope you're doing well", "I wanted to reach out", "Just circling back", "If helpful", "I noticed that", "I came across your business".
- Prefer simple, conversational openers like: "Quick question.", "Saw your page and had a quick question.", "Curious if you already have this set up." When the business name fits naturally you can start with it (e.g. "Hi Yoga Commons, quick question.").
- Be lightly channel-aware: in the first message, reference the likely inquiry channels (website, phone, social) when it fits so it reads specific rather than generic. Do not create separate messages per channel.
Voice examples (match the tone, do not copy verbatim):
- First: "Hi Yoga Commons, quick question. Do you already have a simple way to follow up when someone asks about classes, intro offers, or memberships?"
- Follow-up: "Wanted to check back on this. A simple follow-up flow can help make sure new inquiries do not get lost between the website, phone, and social pages."
- Close-the-loop: "Totally understand if this is not a priority right now. I'll close the loop here. Thought it might be useful since missed follow-up is easy to overlook until leads start slipping."
