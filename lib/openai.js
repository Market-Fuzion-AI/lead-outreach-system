...
- social_channel_fit: 0-15 (is IG/FB plausibly relevant to how customers reach them? Score toward the top of the range ONLY when social_evidence is "high"; if "possible", keep it modest; if "none", keep it low but do NOT heavily penalize the business just for missing social data)
...
RECOMMENDED OPPORTUNITY (practical and specific, but hedged — you only have public data):
- opportunity_problem: the problem this business may have, hedged with "may"/"likely". Example: "Inquiries may be arriving from calls, website forms, and social messages with no single place to capture them."
- opportunity_offer: a simple service/automation Market Fuzion could offer. Example: "A simple inquiry capture + instant follow-up system."
- opportunity_why: why it matters, framed as outcomes. Example: "Faster responses reduce lost leads and make booking easier."
- opportunity_first_offer: one friendly, low-pressure sentence proposing a first step. Example: "I can help set up a simple system that replies to new inquiries and routes qualified people to your booking page."
Never overclaim; base all four on the available public data only.

RETURN a JSON object with EXACTLY these keys:
inbound_lead_dependence, follow_up_urgency, social_channel_fit, automation_opportunity_score, ability_to_pay, personalization_quality, confidence_score, visible_cta, likely_lead_gap, likely_follow_up_gap, opportunity_problem, opportunity_offer, opportunity_why, opportunity_first_offer, recommended_channel, first_message, follow_up_1, follow_up_2, close_the_loop, notes
